...
evaluation_criteria_product_manager = "The answer should be user stories that follow the structure: As a [type of user], I want [an action or feature] so that [benefit/value]."
...
# For the 'agent_to_evaluate' parameter, refer to the provided solution code's pattern.
evaluation_criteria_dev_engineer = "The answer should be tasks following this exact structure: Task ID: A unique identifier for tracking purposes\nTask Title: Brief description of the specific development work\nRelated User Story: Reference to the parent user story\nDescription: Detailed explanation of the technical work required\nAcceptance Criteria: Specific requirements that must be met for completion\nEstimated Effort: Time or complexity estimation\nDependencies: Any tasks that must be completed first"
...
def product_manager_support_function(query):
    ...
    if evaluation["final_evaluation"].lower().startswith("yes"):
        return evaluation["final_response"]
    else:
        return f"Product Manager Agent's response did not pass evaluation: {evaluation['final_evaluation']}"
...
def program_manager_support_function(query):
    ...
    if evaluation["final_evaluation"].lower().startswith("yes"):
        ...
        return f"Program Manager Agent's response did not pass evaluation: {evaluation['final_evaluation']}"
...
def development_engineer_support_function(query):
    ...
    if evaluation["final_evaluation"].lower().startswith("yes"):
        ...
        return f"Development Engineer Agent's response did not pass evaluation: {evaluation['final_evaluation']}"
...
routing_agent = RoutingAgent(openai_api_key, agents=[
    {
        ...
        "description": "Responsible for defining product features and requirements.",
        "func": product_manager_support_function
    },
    {
        "name": "Program Manager",
        "description": "Responsible for managing the development program and ensuring alignment with business goals.",
        "func": program_manager_support_function
    },
    {
        "name": "Development Engineer",
        "description": "Responsible for defining development tasks and technical implementation details.",
